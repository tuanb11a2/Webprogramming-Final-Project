...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 23, 2021 lúc 02:58 PM
...
CREATE TABLE `book` (
  ...
  `thumbnail_address` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bookPDF` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
...
--
ALTER TABLE `role`
  MODIFY `rold_id` int(11) NOT NULL AUTO_INCREMENT;
